...
6. **Universal Cover Geometry** $(\tilde{\mathrm{SL}}(2, \mathbb{R}))$: Unit Tangent Bundles over Hyperbolic Surfaces ([`Formalization/SL2RGeometry/`](Formalization/SL2RGeometry.lean))
