...
The formalization resides in the \texttt{Formalization.PoincareDodecahedron} module tree within the public repository at \url{https://github.com/sneed-and-feed/original-research} (commit \texttt{6b108df}). Table \ref{tab:lean} maps each analytical result to its verified formal declaration.
...
Spinor Representation Multiplicities ($m_0=1, m_1..m_{11}=0, m_{12}=1$) & \texttt{SpectralDecomposition.lean} & \texttt{m\_zero} $\dots$ \texttt{m\_twelve} \\
